...
from social_media_project.apps.user_service.serializers import UserSerializer, UserCreateSerializer, UserUpdateSerializer, UserLoginAPIViewSerializer
...
class TestUserAPI(TestCase):
    ...
    def test_delete_user(self):
        ...
        """
        url = reverse('delete_user', args=[self.user.id])  # Update this to the correct name for your user delete view
    ...
    def test_me_endpoint(self):
        ...
        """
        url = reverse('get_current_user')  # Update this to the correct name for your user "me" endpoint
        response = self.client.get(url)
